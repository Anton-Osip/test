...
type TodoFromServerTypeWithId = TodoFromServerType & {
    todolistId: string
...
function App() {
    ...
    let [todolists, setTodolists] = useState<Array<TodoFromServerTypeWithId>>([])

    useEffect(() => {
        setTodolists(todoFromServer.map(tl => ({...tl, todolistId: v1()})))
    }, [])
    ...
    function addTask(title: string, todolistId: string) {
        ...
        setTodolists(todolists.map(tl => tl.todolistId === todolistId ? {...tl, tasks: [...tl.tasks, newTask]} : tl))
    }
