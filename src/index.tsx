// Экзамен для 14-го уровня
// 🐱 Thunk

//-------------------------------1-----------------------

// dispatch(addCommentTC()) OK
//
...
// void RootState unknown ActionsType OK
...
// const currentPost = getState().posts.find((p: PostType) => p.id === postId); OK
//
// import React, { useEffect } from "react";
// import ReactDOM from "react-dom/client";
// import { ThunkAction, ThunkDispatch } from "redux-thunk";
...
// RootState unknown ActionsType OK
//
// import axios from "axios";
// import React, { useEffect } from "react";
// import ReactDOM from "react-dom/client";
